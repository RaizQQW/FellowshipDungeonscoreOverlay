(() => {
  const I18N: Record<LanguageCode, Record<string, string>> = {
    ...
    ru: {
      ...
      showDungeonScores: 'Показывать лучшие результаты подземелий',
      dungeonScoresTitle: 'Лучшие результаты',
      noDungeonScores: 'Пока нет засчитанных прохождений',
      showDeathLog: 'Показывать журнал смертей',
      deathLogTitle: 'Журнал смертей',
      noDeaths: 'Пока нет смертей',
      revivedSuffix: '(воскрешён)',
      oneShot: 'ваншот',
      trickle: 'по чуть-чуть',
      burst: 'берст',
      hitsSuffix: 'ударов',
      showCastAlerts: 'Показывать опасные касты мобов',
      previewCastAlerts: 'Превью кастов (тест)',
      castAlertsTitle: 'Опасные касты',
      noCastsNearby: 'Нет опасных кастов рядом',
    ...
    en: {
      ...
      showDungeonScores: 'Show dungeon best scores',
      dungeonScoresTitle: 'Dungeon best scores',
      noDungeonScores: 'No counted clears yet',
      showDeathLog: 'Show death log',
      deathLogTitle: 'Death log',
      noDeaths: 'No deaths this run',
      revivedSuffix: '(rezzed)',
      oneShot: 'one-shot',
      trickle: 'trickle',
      burst: 'burst',
      hitsSuffix: 'hits',
      showCastAlerts: 'Show mob cast alerts',
      previewCastAlerts: 'Preview cast alerts (test)',
      castAlertsTitle: 'Interrupt alerts',
      noCastsNearby: 'No dangerous casts nearby',
