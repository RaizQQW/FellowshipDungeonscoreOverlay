(() => {
  ...
  const DUNGEON_SCORES_PANEL_POSITION_KEY = 'overlay-dungeon-scores-panel-position-v1';
  ...
  const DEFAULT_OVERLAY_SETTINGS: OverlaySettings = {
    ...
    panelPositions: {
      ...
      dungeonScores: { ...DEFAULT_DUNGEON_SCORES_PANEL_POSITION },
    },
  ...
  window.OverlayRendererConstants = {
    ...
    DUNGEON_SCORES_PANEL_POSITION_KEY,
