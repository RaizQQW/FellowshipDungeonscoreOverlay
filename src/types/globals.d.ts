...
type DungeonBestScores = import('./overlay').DungeonBestScores;
type HeroBestScores = import('./overlay').HeroBestScores;
type DungeonScoresPayload = import('./overlay').DungeonScoresPayload;
type DungeonScoresPanelVisibilityArgs = import('./overlay').DungeonScoresPanelVisibilityArgs;
type RenderDungeonScoresPanelArgs = import('./overlay').RenderDungeonScoresPanelArgs;
